...
CMDs[#CMDs + 1] = {NAME = 'remotespy / 
	', DESC = 'Opens FrostHook Spy'}
...
addcmd('explorer',{'dex'},function(args, speaker)
	...
	local Dex = loadstring(game:HttpGet("https://raw.githubusercontent.com/loglizzy/dex-custom-icons/main/main.lua"))()
	Dex.Parent = PARENT
